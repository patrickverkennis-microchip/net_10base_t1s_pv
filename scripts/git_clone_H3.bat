...
git clone -b "v3.19.6"              %H3_GITHUB%/csp.git  %H3_INSTALL%/csp   
git clone -b "v3.18.1"              %H3_GITHUB%/dev_packs.git %H3_INSTALL%/dev_packs    
git clone -b "v1.5.0"               %H3_GITHUB%/harmony-services.git %H3_INSTALL%/harmony-services
@REM git clone -b "v3.8.5"               %H3_GITHUB%/mhc.git %H3_INSTALL%/mhc
git clone -b "v3.12.3"              %H3_GITHUB%/net.git %H3_INSTALL%/net
